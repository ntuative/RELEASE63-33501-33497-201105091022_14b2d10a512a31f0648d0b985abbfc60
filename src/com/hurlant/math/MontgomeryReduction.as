package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2083 = param1.invDigit();
         this.var_2082 = this.var_2083 & 32767;
         this.var_2907 = this.var_2083 >> 15;
         this.var_2908 = 131071;
         this.var_2909 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_188) > 0)
         {
