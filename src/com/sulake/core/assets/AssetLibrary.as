package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1230:String = "AssetLibraryReady";
      
      public static const const_885:String = "AssetLibraryLoaded";
      
      public static const const_1608:String = "AssetLibraryUnloaded";
      
      public static const const_1637:String = "AssetLibraryLoadError";
      
      private static const const_469:String = "name";
      
      private static const const_1070:String = "asset";
      
      private static const const_1071:String = "param";
      ...
      private static var var_2022:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_552:uint = 0;
      
      private static var var_1048:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_551 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_670 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1072);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_469);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1071);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_670 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1048.splice(var_1048.indexOf(this),1);
            --var_552;
            this.var_551 = null;
            this.var_1049 = null;
            this.var_165 = null;
      ...
      {
         if(this.var_670 == param1.url && this.var_1050)
         {
            if(!this.var_1047 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_671);
            }
            this.var_1047 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1230));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_551)
         {
            _loc2_ = this.var_551[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_551[_loc1_];
         }
         ...
         this.var_1050 = false;
         this.var_670 = null;
         dispatchEvent(new Event(AssetLibrary.const_1608));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_551[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1300,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1286,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1124,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_551[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_551[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_551[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_165[param1] != null || (this.var_671 != null ? this.var_671[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2022.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_469.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_469[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_469[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_469)
         {
            _loc3_ = AssetTypeDeclaration(this.var_469[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_469)
         {
            _loc4_ = AssetTypeDeclaration(this.var_469[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_671 = _loc2_.resource;
         this.var_670 = _loc2_.url;
         if(this.var_1047)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_671);
         }
         this.var_1050 = true;
         dispatchEvent(new Event(AssetLibrary.const_885));
         dispatchEvent(new Event(AssetLibrary.const_1230));
         if(this.var_1047)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1637));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1072);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_469).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_670 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_671[param1]);
                  _loc6_ = _loc3_.child(const_1071);
                  if(_loc6_.length())
                  {
