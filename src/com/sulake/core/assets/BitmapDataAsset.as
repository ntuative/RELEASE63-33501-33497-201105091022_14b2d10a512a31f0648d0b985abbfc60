   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_106 is BitmapDataAsset)
         {
            ...
            this.var_1622 = BitmapDataAsset(this.var_106).var_1622;
            this.var_1621 = BitmapDataAsset(this.var_106).var_1621;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1622 = _loc4_ == "1" || _loc4_ == "HabboCatalogCom_ctlg_infopage2";
                  break;
               case "flipV":
                  this.var_1621 = _loc4_ == "1" || _loc4_ == "HabboCatalogCom_ctlg_infopage2";
                  break;
            }
            _loc2_++;
         }
