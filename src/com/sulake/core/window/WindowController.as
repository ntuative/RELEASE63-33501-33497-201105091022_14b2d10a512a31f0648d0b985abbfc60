package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1341:String = "_COLORIZE";
      
      protected static const const_1342:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1028:Point = new Point();
      ...
      protected var var_706:Function;
      ...
      {
         return this.var_706 != null ? this.var_706 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_483 = param1;
         var_237 = !!var_483 ? uint(var_237 | var_579) : uint(var_237 & 16777215);
      ...
      {
         var_579 = param1 & 4278190080;
         var_237 = !!var_483 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_579 = param1 << 24;
         var_237 = !!var_483 ? uint(var_579 | var_237) : uint(16777215 & var_237);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1308);
      }
      ...
      {
         var_484 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_964);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_78)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1342) == -1)
               {
                  _loc4_.style = var_78;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_355 = this._parent.rectangle.clone();
               var_60.x = var_11.x;
               var_60.y = var_11.y;
               var_60.width = var_11.width;
               var_60.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_473,this,this._parent);
            ...
            else
            {
               this.var_355.x = 0;
               this.var_355.y = 0;
               this.var_355.width = 0;
               this.var_355.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1668,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_765,var_11);
            this.var_20.visible = var_303;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_18,_context,var_11,null,this.var_706,this.properties,var_878.concat(),_id) as WindowController;
         _loc2_.var_484 = var_484;
         _loc2_.var_171 = this.var_171;
         _loc2_._debug = this._debug;
         _loc2_.var_355 = this.var_355.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2367 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_532)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_583)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(testParamFlag(WindowParam.const_107))
         {
            if(this._parent != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1269,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_250,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_797))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1210;
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_38:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_791,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_203,WindowParam.const_180))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_221,WindowParam.const_179))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_610))
                        {
                        ...
                        var_18 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_155,this._parent,this);
               ...
               case WindowEvent.const_250:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1266);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1779,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_528:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1207,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_332,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_473:
                  if(testParamFlag(WindowParam.const_203,WindowParam.const_180))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_791:
                  this._parent.getRegionProperties(null,this.var_355);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_484);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_484);
      }
         ...
         if(this.var_171 && var_484 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1028,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1028,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_78 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1342) == -1)
               {
                  _loc6_.style = var_78;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_150,WindowParam.const_180);
         ...
         if(_loc1_ || _loc2_)
         {
            ...
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_355.width;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_448)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_355.height;
               _loc5_ = uint(var_18 & 0);
               ...
               else if(_loc5_ == WindowParam.const_221)
               {
         ...
         else if(testParamFlag(WindowParam.const_107))
         {
            _loc3_ = var_11.clone();
            if(this._parent != null)
            {
      ...
      {
         if(_state == WindowState.const_560)
         {
            return true;
         }
         _state = WindowState.const_560;
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_369,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function maximize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1665,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1788,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_598,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1770,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_967,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_214,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1632,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1845,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1174 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_586,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1174 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_586,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_408,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
