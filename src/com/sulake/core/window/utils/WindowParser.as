package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1955:String = "_INCLUDE";
      
      public static const const_2008:String = "_TEMP";
      
      private static const const_1370:String = "layout";
      
      private static const const_1000:String = "window";
      
      private static const const_1001:String = "variables";
      
      private static const const_999:String = "filters";
      
      private static const const_469:String = "name";
      
      private static const const_1366:String = "style";
      
      private static const const_656:String = "params";
      
      private static const const_1364:String = "tags";
      ...
      private static const const_1360:String = "visible";
      
      private static const const_1373:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1308:String = "blend";
      
      private static const const_1371:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1372:String = "treshold";
      
      private static const const_1359:String = "children";
      
      private static const const_1368:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1369:String = "height_min";
      
      private static const const_1367:String = "height_max";
      
      private static const const_657:String = "HabboCatalogCom_ctlg_infopage2";
      
      private static const const_188:String = "0";
      
      private static const const_1365:String = "$";
      
      private static const const_1363:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1362:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1361:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1092:Dictionary;
      
      protected var var_1637:Dictionary;
      
      protected var var_2154:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1349,this.var_1348);
         this.var_1092 = new Dictionary();
         this.var_1637 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1092,this.var_1637);
         this.var_2154 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1361,const_50);
         return param1.replace(const_1362,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1092)
            {
               delete this.var_1092[_loc1_];
            }
            for(_loc1_ in this.var_1637)
            {
               delete this.var_1637[_loc1_];
            }
            this.var_2154.dispose();
            this.var_2154 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1370)
         {
            ...
            _loc9_ = param1.child(const_999).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1000);
         ...
         if(param1.localName() == const_1000)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1349[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_469,variables,"")));
         style = uint(this.parseAttribute(xml,const_1366,variables,style));
         params = uint(this.parseAttribute(xml,const_656,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1364,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_188));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_188));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_188));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_188));
         visible = this.parseAttribute(xml,const_1360,variables,visible.toString()) == const_657;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_656).length() > 0)
         {
            list = xml.child(const_656).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_469,variables,"") as String;
               if(this.var_1092[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_469)) + "\"!");
               }
               params |= this.var_1092[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1373,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1363);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1368,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1369,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1367,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_657;
         blend = Number(this.parseAttribute(xml,const_1308,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1371,variables,window.clipping.toString()) == const_657;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1372,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_999).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_221)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1348[param1.type];
