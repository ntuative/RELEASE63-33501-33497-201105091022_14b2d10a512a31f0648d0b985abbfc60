package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "HabboCatalogCom_ctlg_infopage2";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "HabboCatalogCom_ctlg_infopage2";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_402 = SkinLayoutEntity.const_639;
                  break;
               case "move":
                  _loc5_.var_402 = SkinLayoutEntity.const_316;
                  break;
               case "strech":
                  _loc5_.var_402 = SkinLayoutEntity.const_482;
                  break;
               case "tiled":
                  _loc5_.var_402 = SkinLayoutEntity.const_349;
                  break;
               case "center":
                  _loc5_.var_402 = SkinLayoutEntity.const_1325;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_404 = SkinLayoutEntity.const_639;
                  break;
               case "move":
                  _loc5_.var_404 = SkinLayoutEntity.const_316;
                  break;
               case "strech":
                  _loc5_.var_404 = SkinLayoutEntity.const_482;
                  break;
               case "tiled":
                  _loc5_.var_404 = SkinLayoutEntity.const_349;
                  break;
               case "center":
                  _loc5_.var_404 = SkinLayoutEntity.const_1325;
            }
         }
