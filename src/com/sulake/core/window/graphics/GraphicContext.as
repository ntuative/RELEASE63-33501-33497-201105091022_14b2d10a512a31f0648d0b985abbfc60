package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1615:uint = 0;
      
      public static const const_765:uint = 1;
      
      public static const const_1112:uint = 2;
      
      public static const const_695:uint = 4;
      
      public static const const_1849:uint = 8;
      
      public static const const_1641:uint = 16;
      
      public static const const_1959:uint = 64;
      
      public static const const_1971:uint = 128;
      
      public static const const_1145:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1112:
               ...
               break;
            case GraphicContext.const_1849:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1641:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_695:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1145:
               break;
            case GraphicContext.const_1615:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_213.numChildren > 0)
               {
                  this.var_213.removeChildAt(0);
               }
            }
            this.var_213 = null;
            while(numChildren > 0)
         ...
         if(this.var_879)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2167,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2167,16777215);
                  }
                  var_338 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_213 == null)
         {
            this.var_213 = new Sprite();
            this.var_213.name = this.name + " - Child Container";
            this.var_213.mouseEnabled = false;
            addChild(this.var_213);
         }
         return this.var_213;
      }
      ...
      {
         return this.var_213 != null ? int(this.var_213.numChildren) : 0;
      }
