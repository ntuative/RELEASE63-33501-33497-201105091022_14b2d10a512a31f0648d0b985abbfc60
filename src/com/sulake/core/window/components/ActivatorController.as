package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_332)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1207)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_887;
         if(this.var_887 != param1)
         {
            if(this.var_887 != null)
            {
               if(!this.var_887.disposed)
               {
                  this.var_887.deactivate();
               }
            }
            this.var_887 = param1;
