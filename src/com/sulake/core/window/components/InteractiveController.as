package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_565)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_223)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_565)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_868,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_815,param1.toolTipDelay,PropertyStruct.const_272,true));
         }
         else
         {
      ...
      {
         this.var_1365 = param1 == null ? "null" : param1;
      }
