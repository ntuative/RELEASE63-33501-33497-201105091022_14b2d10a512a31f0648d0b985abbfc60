package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1194:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_439)
         {
            this.var_439.removeEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            this.var_439.removeEventListener(WindowEvent.const_214,this.scrollBarEventProc);
            this.var_439 = null;
         }
         if(this.var_1194)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1194)
         {
            this.var_1194 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_439)
         {
            ...
            if(this.var_439)
            {
               this.var_439.addEventListener(WindowEvent.const_254,this.scrollBarEventProc);
               this.var_439.addEventListener(WindowEvent.const_214,this.scrollBarEventProc);
            }
         }
         return this.var_439;
      }
