package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function ItemGridController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _horizontal = param2 != WindowType.const_570;
         var_480 = true;
         if(!_horizontal)
         {
      ...
      override public function get scrollStepH() : Number
      {
         ...
         return !!_horizontal ? 0 : Number(0 / this.method_1);
      }
      ...
      public function getGridItemAt(param1:uint) : IWindow
      {
         ...
         return _loc2_.getListItemAt(param1 / this.method_1);
      }
      ...
      public function getGridItemIndex(param1:IWindow) : int
      {
         ...
         return _loc2_.getListItemIndex(param1) * this.method_1 + this.getColumnIndex(_loc2_);
      }
      ...
      {
         return getListItemAt(param1 % this.method_1) as IItemListWindow;
      }
      
      public function getColumnNumberByItemIndex(param1:uint) : uint
      {
         return param1 % this.method_1;
      }
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            _loc6_ = _loc5_ > -1 ? _loc5_ == this.method_1 - 1 : true;
            if(_loc6_)
            {
      ...
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_423,WindowStyle.const_121,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),this.listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
      ...
      protected function offsetGridItemsForwards(param1:IWindow, param2:uint) : void
      {
         ...
         else
         {
            ...
            this.resolveColumnByIndex(param2).addListItemAt(param1,param2 / this.method_1);
         }
         var _loc10_:* = 0;
         _loc9_ = 0;
         while(_loc9_ < _loc6_)
