package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_411,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_411 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_411,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_852 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_876 * this.maxScrollH,this.var_573 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_846,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1225));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1257 ? new PropertyStruct(PropertyDefaults.const_708,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1216) : PropertyDefaults.const_1868);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1311 ? new PropertyStruct(PropertyDefaults.const_1131,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1158) : PropertyDefaults.const_1698);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_943) ? new PropertyStruct(PropertyDefaults.const_397,this._field.textColor,PropertyStruct.const_161,true) : PropertyDefaults.const_1292);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_790 ? new PropertyStruct(PropertyDefaults.const_262,this.var_40.left,PropertyStruct.const_43,true) : PropertyDefaults.const_476);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_737 ? new PropertyStruct(PropertyDefaults.const_292,this.var_40.top,PropertyStruct.const_43,true) : PropertyDefaults.const_574);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_830 ? new PropertyStruct(PropertyDefaults.const_240,this.var_40.right,PropertyStruct.const_43,true) : PropertyDefaults.const_475);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_710 ? new PropertyStruct(PropertyDefaults.const_255,this.var_40.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_517);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1221 ? new PropertyStruct(PropertyDefaults.const_811,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1826);
