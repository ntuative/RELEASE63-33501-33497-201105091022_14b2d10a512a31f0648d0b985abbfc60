package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1428:String = "_TITLE";
      
      private static const const_1430:String = "_HEADER";
      
      private static const const_1427:String = "_CONTENT";
      
      private static const const_1429:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1462:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1428) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1462 = findChildByTag(const_1430) as IHeaderWindow;
            if(!this.var_1462)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_186 = findChildByTag(const_1427) as IWindowContainer;
            if(!this.var_186)
            {
      ...
      {
         return findChildByTag(const_1429) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1341,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1100 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_242);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_331,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_292,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_240,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
