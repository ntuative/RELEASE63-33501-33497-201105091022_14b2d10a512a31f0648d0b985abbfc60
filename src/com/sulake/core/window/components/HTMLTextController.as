package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1068:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_2064:StyleSheet = null;
      ...
      {
         this.var_854 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1315 == param2)
         {
            return;
         }
         param1.var_1315 = param2;
         param1.var_2064 = null;
         if(param1.var_1315 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1315);
            param1.var_2064 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_831.indexOf(param1) > -1)
         {
            this.var_854 = param1;
         }
      }
      ...
      {
         return this.var_854 == LinkTarget.const_30 ? defaultLinkTarget : this.var_854;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_2064;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1120)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_854 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_903,this.var_854,PropertyStruct.const_54,true,PropertyDefaults.const_831));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_903)
            {
