package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1481:String = "_SELECTOR";
      
      private static const const_1480:String = "_CONTENT";
       
      
      protected var var_1099:ITabSelectorWindow;
      
      protected var var_2166:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1099 = findChildByTag(const_1481) as ITabSelectorWindow;
            if(this.var_1099 != null)
            {
               this.var_1099.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2166 = findChildByTag(const_1480) as IWindowContainer;
         }
      ...
      {
         return !!this.var_722 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1099.numSelectables;
      }
