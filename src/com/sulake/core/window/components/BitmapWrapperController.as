package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_576 != PropertyDefaults.const_1297)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_978,this.var_576,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1700);
         }
         if(this.var_877 != PropertyDefaults.const_1278)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_890,this.var_877,PropertyStruct.const_54,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1840);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_978:
