package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1877:int = 10000;
      ...
      private var var_1231:IEncryption;
      
      private var var_806:IProtocol;
      
      private var _id:String;
      
      private var var_1232:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1232 = new MessageClassManager();
         this.var_81 = new Socket();
         this.var_204 = new Timer(const_1877,1);
         this.var_204.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_204.stop();
            this.var_204.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_204 = null;
         this.var_529 = null;
         this.var_528 = null;
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_259.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1232.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_528)
         {
            this.var_528.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1231 != null)
         {
            _loc3_ = this.var_1231.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1232.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1231 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_806.getMessages(this.var_529,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1232.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_204.stop();
         this.var_1915 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_807));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1915 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_807));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_807));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_807));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_807));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_807));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_204.delay + " ms). Possible Firewall.";
