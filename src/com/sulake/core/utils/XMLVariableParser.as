package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1610:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1683:String = "bool";
      ...
      private static const const_678:String = "value";
      
      private static const const_657:String = "HabboCatalogCom_ctlg_infopage2";
      
      private static const const_1927:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_678));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_678)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_284 || _loc5_ == const_160)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1610:
               return Number(param1);
            case const_39:
               return param1 == const_657 || int(param1) > 0;
            case const_1683:
               return param1 == const_657 || int(param1) > 0;
            case const_161:
               return uint(param1);
            case const_160:
               return param1.split(const_1363);
            default:
