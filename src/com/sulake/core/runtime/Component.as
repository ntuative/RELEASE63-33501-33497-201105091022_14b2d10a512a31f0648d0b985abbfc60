package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_452:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1250:uint = 4;
       
      
      protected var var_818:uint = 0;
      ...
      private var var_523:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_523 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_523.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_523.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1400 & const_1250)
         {
            if(_loc3_ == 0)
            {
               if(this.var_523.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_960 = false;
            this._events.dispatchEvent(new LockEvent(const_452,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_818 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_523.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_523.getStructByIndex(_loc8_);
