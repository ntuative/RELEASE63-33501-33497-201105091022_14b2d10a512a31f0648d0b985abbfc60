package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_170,RoomObjectMoveEvent.const_394];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2444)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_211,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1412 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_867,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_225);
            _loc2_.setString(RoomObjectVariableEnum.const_225,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1689,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_800,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_211,_loc3_ + this.var_955);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1829;
            _loc2_.setNumber(RoomObjectVariableEnum.const_263,this.var_1829);
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1828;
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,this.var_1828);
         }
         else
         {
            this.var_955 += 45;
