package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1510:String = "head";
      
      private static const const_676:int = 1;
      
      private static const const_1065:int = 1000;
      
      private static const const_1511:String = "pet_experience_bubble_png";
      
      private static const const_1508:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1511) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2751)
            {
               this.var_2751 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_144)
         {
            ...
            this.var_1662 = _loc3_.getNumber(RoomObjectVariableEnum.const_443) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_211);
            if(!isNaN(_loc8_))
            {
               this.var_1997 = _loc8_;
            }
            else
            {
               this.var_1997 = direction;
            }
            this.var_1423 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2302 = _loc3_.getNumber(RoomObjectVariableEnum.const_867);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_800);
            if(_loc9_ != this.var_1998)
            {
               this.var_1998 = _loc9_;
               this.var_2752 = this.var_1998.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_389 != null)
         {
            ...
            if(this.var_1423 > 0)
            {
               _loc2_ = param1 - this.var_1423;
               if(_loc2_ < const_1065)
               {
                  this.var_389.alpha = int(Math.sin(_loc2_ / const_1065 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_241)
         {
            ...
            this.setAnimationForIndex(const_1508,_loc3_);
         }
         if(param2 != this.var_1376)
         {
            this.var_1376 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_88,param2);
            this.setAnimationForIndex(const_1509,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_676;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2752);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_676)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_676))
            {
               if(param2 >= FurnitureVisualizationData.const_572.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_572[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1997);
         }
         return direction;
      }
      ...
      {
         if(this.var_1037[param1] == null)
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1510)
            {
               this.var_1037[param1] = true;
            }
            else
            {
               this.var_1037[param1] = false;
            }
         }
         return this.var_1037[param1];
      }
   }
}
