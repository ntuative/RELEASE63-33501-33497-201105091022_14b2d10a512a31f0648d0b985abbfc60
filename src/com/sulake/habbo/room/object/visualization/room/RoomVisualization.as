package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1824:int = 16777215;
      
      public static const const_1631:int = 13421772;
      
      private static const const_1052:int = 16777215;
      
      private static const const_1051:int = 13421772;
      
      private static const const_1050:int = 10066329;
      
      private static const const_1053:int = 10066329;
      
      public static const const_1617:int = 16777215;
      
      public static const const_1782:int = 13421772;
      
      public static const const_1807:int = 10066329;
      ...
      private var var_810:Rectangle = null;
      ...
      private var var_1919:String = null;
      
      private var var_1242:uint = 16777215;
      
      private var var_2630:int = 255;
      
      private var var_2629:int = 255;
      
      private var var_2631:int = 255;
      ...
      private const const_2178:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_313["null"] = false;
         this.var_313["null"] = true;
         this.var_313["null"] = true;
         this.var_313["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_139 != null)
         {
            ...
            {
               _loc2_ = this.var_139[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_810 = super.boundingRectangle;
         }
         return new Rectangle(this.var_810.x,this.var_810.y,this.var_810.width,this.var_810.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_118 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_118)
               {
                  _loc4_.tag = "plane.wall@" + (_loc2_ + 1);
               }
               else if(_loc3_.type == RoomPlane.const_237)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1518))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1518;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1307);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1122);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_183)
            {
               ...
               {
                  _loc13_.color = const_1053;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1052;
               }
               else if(_loc14_.y == 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_310)
            {
               ...
               {
                  _loc13_.color = const_1782;
               }
               else
               {
                  _loc13_.color = const_1807;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1739)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_118,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_310)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1914 + this.const_2178 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_378.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1920)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2631 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2629 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2630 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1802)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1493 || _loc3_.y != this.var_2578 || _loc3_.z != this.var_2577 || param1.scale != this.var_1921))
            {
               this.var_1493 = _loc3_.x;
               this.var_2578 = _loc3_.y;
               this.var_2577 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1295);
            if(_loc3_ != this.var_1919)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1919 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_799));
            if(_loc4_ != this.var_1242)
            {
               this.var_1242 = _loc4_;
               this.var_2631 = this.var_1242 & 255;
               this.var_2629 = this.var_1242 >> 8 & 255;
               this.var_2630 = this.var_1242 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1322));
            if(_loc5_ != this.var_1920)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_144 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_694));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_713));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_968));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_144 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1115);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1281);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1518))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_139.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_118 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_313["null"] || param2 != this.var_313["null"] || param3 != this.var_313["null"])
         {
            this.var_313["null"] = param1;
            this.var_313["null"] = param2;
            this.var_313["null"] = param3;
            this.var_378 = [];
            this.var_651 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_313[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1241;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_532.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_532.maskCount)
         {
            _loc10_ = this.var_532.getMaskType(_loc8_);
            _loc11_ = this.var_532.getMaskLocation(_loc8_);
            _loc12_ = this.var_532.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_139.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_118 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_118 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_297)
                              {
