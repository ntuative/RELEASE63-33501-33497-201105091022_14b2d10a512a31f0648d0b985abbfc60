package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2126:int = 16777216;
      ...
      private var var_2001:int = 16777216;
      
      private var var_3003:int = 69069;
      
      private var var_3004:int = 5;
      ...
      {
         var _loc1_:int = this.var_3003 * this.var_2002 + this.var_3004;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2001;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2001 * param2);
      }
   }
}
