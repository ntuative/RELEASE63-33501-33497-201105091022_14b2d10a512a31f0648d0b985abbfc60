package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1843:TriggerConfs;
      
      private var var_1842:ActionTypes;
      
      private var var_1841:ConditionTypes;
      
      private var var_254:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_781:RoomObjectHightLighter;
      ...
      {
         this.var_1843 = new TriggerConfs();
         this.var_1842 = new ActionTypes();
         this.var_1841 = new ConditionTypes();
         this.var_254 = new Dictionary();
         super();
         this.var_79 = param1;
         this.var_781 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1197 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1197.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1197.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_781.hideAll(this.var_254);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_781.showAll(this.var_254);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1197.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1197.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1470) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1470 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1843);
         this.refreshConfigureElement(this.var_1842);
         this.refreshConfigureElement(this.var_1841);
