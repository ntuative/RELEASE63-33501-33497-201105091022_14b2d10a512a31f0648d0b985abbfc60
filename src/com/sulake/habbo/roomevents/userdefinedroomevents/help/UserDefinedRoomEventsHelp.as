package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1971:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1971 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1270 = this.var_1971.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1270)
         {
            this.var_1270.procedure = this.onButtonClick;
         }
         this.var_1269 = this.var_1971.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1269)
         {
            this.var_1269.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_267 >= this.var_58.length - 1)
         {
            this.var_1269.disable();
         }
         else
         {
            this.var_1269.enable();
         }
         if(this.var_267 <= 0)
         {
            this.var_1270.disable();
         }
         else
         {
            this.var_1270.enable();
         }
      }
      ...
      {
         ++this.var_267;
         this.var_267 = Math.min(this.var_267,this.var_58.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_267;
         this.var_267 = Math.max(this.var_267,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_58[this.var_267][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_58[this.var_267][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_58[this.var_267][1]).value;
