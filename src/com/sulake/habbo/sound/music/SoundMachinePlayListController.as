package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_228:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_228 = param2;
         this.var_771 = [];
         this.var_771.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_771.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_771)
         {
         ...
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_781,this.onSoundMachinePlayEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_781,this.onSoundMachinePlayEvent);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachineStopEvent);
               this.var_79 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_459);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_228.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_459 = -1;
         this.var_663 = false;
         this.var_228.stop(HabboMusicPrioritiesEnum.const_137);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_228.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_228.playSong(param1,HabboMusicPrioritiesEnum.const_137,_loc3_,0,0,0))
         {
