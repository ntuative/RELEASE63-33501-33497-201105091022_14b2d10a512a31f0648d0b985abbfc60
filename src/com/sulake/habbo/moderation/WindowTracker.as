package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1333:int = 3;
      ...
      public static const const_1727:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1744:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1800[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1800[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
