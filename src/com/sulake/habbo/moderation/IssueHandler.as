package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_1102 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         ...
         {
            this.var_1102.load(_loc4_,this.var_149.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_62 != null && this.var_62.issueManager != null && this.var_149 != null)
         {
            this.var_62.issueManager.removeHandler(this.var_149.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_149.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_149.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_149.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.releaseBundle(this.var_149.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_62,WindowTracker.const_1333,_loc2_),this._window,false,false,true);
      }
