package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_926:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_32.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_350));
         Logger.log("BEGINNING TO SHOW: " + this.var_350);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_350);
         if(param1.flatId != this.var_350)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_350);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1154 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1154);
         this.var_1154.procedure = this.onSelectTemplate;
         this.var_926 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_32,WindowTracker.const_787,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_926.isSelected);
         this.var_32.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1864,_loc2_,this.var_570.text,"",""));
         if(this.var_1427.isSelected || this.var_1428.isSelected || this.var_926.isSelected)
         {
            this.var_32.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1427.isSelected,this.var_1428.isSelected,this.var_926.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1777);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.roomMessageTemplates[this.var_1154.selection];
         if(_loc3_ != null)
         {
            this.var_642 = false;
            this.var_570.text = _loc3_;
         }
      }
   }
}
