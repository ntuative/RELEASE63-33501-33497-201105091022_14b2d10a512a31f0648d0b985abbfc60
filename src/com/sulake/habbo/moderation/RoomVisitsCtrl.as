package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_826 = IWindowContainer(this.var_32.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1589;
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1547)
         {
