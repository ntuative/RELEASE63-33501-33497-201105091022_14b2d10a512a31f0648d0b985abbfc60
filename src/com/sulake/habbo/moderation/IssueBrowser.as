package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2164:String = "my_issues";
      
      private const const_2165:String = "open_issues";
      
      private const const_2166:String = "picked_issues";
      ...
      private var var_1674:IIssueBrowserView;
      
      private var var_1672:IIssueBrowserView;
      
      private var var_1673:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2164:
               if(this.var_1674 == null)
               {
                  this.var_1674 = new MyIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1674;
            case this.const_2165:
               if(this.var_1672 == null)
               {
                  this.var_1672 = new OpenIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1672;
            case this.const_2166:
               if(this.var_1673 == null)
               {
                  this.var_1673 = new PickedIssuesView(this.issueManager,this,this.var_242.container);
               }
