package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1058:int = 3600;
      
      private static const const_1060:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_1058)
         {
            return Math.round(param1 / const_1059) + " mins ago";
         }
         if(param1 < 2 * const_1060)
         {
            return Math.round(param1 / const_1058) + " hours ago";
         }
         if(param1 < 2 * const_1061)
         {
            return Math.round(param1 / const_1060) + " days ago";
         }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1257.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_32.getXmlWindow("user_info"));
            this.var_1257.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_32,WindowTracker.const_1212,this._data.userId),this._callerFrame,this.var_1256,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new RoomVisitsCtrl(this.var_32,this._data.userId),this._callerFrame,this.var_1256,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new SendMsgsCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1629),this._callerFrame,this.var_1256,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ModActionCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1629),this._callerFrame,this.var_1256,false,true);
      }
