package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_2056;
      ...
      {
         return WindowTracker.const_1803;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.messageTemplates[this.var_1154.selection];
         if(_loc3_ != null)
         {
            this.var_642 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.connection.send(new ModMessageMessageComposer(this.var_1630,this.var_570.text,this.var_1629));
         this.dispose();
      }
