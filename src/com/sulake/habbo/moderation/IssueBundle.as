package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_785:IssueMessageData = null;
      
      private var var_786:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2501 = param2.pickerUserId;
         this.var_2502 = param2.pickerUserName;
         this.var_1447 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1207 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1206;
         }
         if(this.var_785 == null || param1.timeStamp < this.var_785.timeStamp)
         {
            this.var_785 = param1;
         }
         if(this.var_786 == null || param1.priority > this.var_786.timeStamp)
         {
            this.var_786 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_786;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_785;
         if(_loc2_ == null)
         {
