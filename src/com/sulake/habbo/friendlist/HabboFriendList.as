package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2836:FriendListLookAndFeel;
      
      private var var_431:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2057:OpenedToWebPopup;
      ...
      private var var_2058:AvatarSearchResults;
      ...
      {
         this.var_2836 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_100 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2058 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_684.stop();
            this.var_684.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_684 = null;
         }
         ...
         if(this.var_130)
         {
            this.var_130.release(new IIDHabboMessenger());
            this.var_130 = null;
         }
         if(this.var_191)
         {
         ...
         if(this.var_848)
         {
            this.var_848.release(new IIDSessionDataManager());
            this.var_848 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2057 = new OpenedToWebPopup(this);
         }
         this.var_2057.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_100);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_318,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1136.createAvatarImage(param1,AvatarScaleType.const_97,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboCatalogCom_ctlg_infopage2";
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_130 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_191);
         ...
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_1294,this.getText("friendlist.friends")));
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_400,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_684)
         {
            this.var_684 = new Timer(120000);
            this.var_684.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_684.start();
         }
         ...
         {
            _loc5_ = this.var_100.findCategory(FriendCategory.const_400);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_401));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2058.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         if(!this.var_848 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_848.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_848.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
