package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1040:int = 0;
      ...
      {
         return this.var_638 != const_1040;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1877 != RecyclerStatusMessageEvent.const_1243;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_638 == const_464;
      }
      ...
      {
         this.var_638 = const_1041;
         this.var_114 = new Array(const_208);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_208)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_638 = const_1040;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1587:
               this.var_638 = const_464;
            ...
            case RecyclerStatusMessageEvent.const_1243:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1676:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1317:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1618:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_114.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_208)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_208)
         {
            return false;
         }
         var _loc1_:int = 0;
