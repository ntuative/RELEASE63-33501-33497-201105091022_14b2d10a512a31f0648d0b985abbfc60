package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2181:int = 10;
      ...
      private const const_1904:uint = 4.293848814E9;
      
      private const const_1905:uint = 4.294967295E9;
      
      private const const_1523:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1929 = _loc1_.stuffTypes;
            this.var_815 = _loc1_.boxTypes;
            this.var_816 = _loc1_.ribbonTypes;
            this.var_1250 = this.var_1929[0];
            this.var_381 = this.var_815[0];
            this.var_382 = this.var_816[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_382 < 0)
         {
            this.var_382 = this.var_816.length - 1;
         }
         if(this.var_382 > this.var_816.length - 1)
         {
            this.var_382 = 0;
         }
         if(this.var_381 < 0)
         {
            this.var_381 = this.var_815.length - 1;
         }
         if(this.var_381 > this.var_815.length - 1)
         {
            this.var_381 = 0;
         }
         var _loc1_:int = this.var_815[this.var_381] * 1000 + this.var_816[this.var_382];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1250,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1522 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1929;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1250);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_815[this.var_381]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_816[this.var_382]);
         this._catalog.purchaseProductAsGift(this.var_1523,this.var_92,this.var_1521,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1523,this.var_92.offerId,this.var_1521);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_105:
               ...
               for each(_loc7_ in this.var_226)
               {
                  ...
                  if(_loc5_.length >= this.const_2181)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2640 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_368:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_652 == null)
         {
            this.var_652 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_652.procedure = this.suggestionsEventHandler;
         }
         if(this.var_265 == null || this.var_652 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_652.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1523;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1904) : uint(this.const_1905);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_265.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1250;
               }
            }
            _loc4_++;
         }
