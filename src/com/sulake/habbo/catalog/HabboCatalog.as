package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1924:Boolean = true;
      
      private var var_181:CatalogViewer;
      ...
      private var var_2637:Boolean = true;
      
      private var var_1925:Boolean = false;
      
      private var var_2638:GiftWrappingConfiguration;
      
      private var var_1248:ClubGiftController;
      
      private var var_533:ClubBuyController;
      
      private var var_813:Map;
      
      private var var_1249:Boolean = false;
      
      private var var_1004:IPurchasableOffer;
      
      private var var_1520:IDragAndDropDoneReceiver;
      
      private var var_64:PlacedObjectPurchaseData;
      
      private const const_1090:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this._roomSessionManager != null)
         {
            ...
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_95,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1643);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_533.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_176,this.onObjectPlaced);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_380.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_191.getKey("client.credits.embed.enabled","false") == "HabboCatalogCom_ctlg_infopage2";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_813.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_103.getActivityPointsForType(Purse.const_213)));
         var _loc1_:int = 0;
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_181.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_380 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_181 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_181.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1090;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1925 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1248 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_533 == null)
         {
            this.var_533 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_181 != null)
         {
            this.var_181.catalogWindowClosed();
         }
         if(this.var_91 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_91.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_380.buildCatalogIndex(_loc2_);
         if(this.var_814 && this.var_814 != "")
         {
            this.var_380.openPage(this.var_814);
            this.var_814 = "";
            this.var_1003 = -1;
         }
         else if(this.var_1003 > -1)
         {
            this.var_380.openPageById(this.var_1003,this.var_1926);
            this.var_1003 = -1;
            this.var_1926 = -1;
            this.var_814 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_181.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_181.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2639 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_75,this.var_103.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2637 && this._soundManager != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1248.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_181.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2638 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_813.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_813.add(_loc2_.productCode,_loc3_.slice());
            this.var_181.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "HabboCatalogCom_ctlg_infopage2" == this.var_191.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_191.keyExists("catalog.drag_and_drop") || this.var_191.getKey("catalog.drag_and_drop") != "HabboCatalogCom_ctlg_infopage2")
         {
            return false;
         }
         if(!this.var_1189 || !this.var_1189.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1249 && param1.type == RoomEngineObjectEvent.const_176)
         {
            ...
            _loc3_ = this.var_1004.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1004);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_339,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_222);
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
