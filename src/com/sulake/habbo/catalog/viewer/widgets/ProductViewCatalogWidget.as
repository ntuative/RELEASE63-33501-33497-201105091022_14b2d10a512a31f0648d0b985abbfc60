package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1022 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1265 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1961 = new Point(this.var_86.x,this.var_86.y);
         this.var_538 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1543 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1962 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1022.text = _loc4_;
         this.var_1265.text = _loc5_;
         this.var_1022.height = this.var_1022.textHeight + 5;
         this.var_1265.y = this.var_1022.y + this.var_1022.height;
         this.var_1265.height = Math.max(130,this.var_1265.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_516:
                  _loc6_ = this.var_1962.clone();
                  if(this.var_538 != null)
                  {
                     this.var_538.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_538,this.var_1543,this.var_2049);
                     this.var_538.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_200:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_330,AvatarAction.const_592);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2704)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2704 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1961.x;
            this.var_86.y = this.var_1961.y;
            if(param3 != null)
            {
