   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_620 != null && this.var_620 == param2)
         {
            if(this.var_92)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_92);
               this.var_620 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1781 = _loc3_.id;
            this.var_1780 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_360 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_360,this._imageStoreWindow);
         }
      }
   }
}
