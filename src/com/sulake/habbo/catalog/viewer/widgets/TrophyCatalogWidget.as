package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1422:int = 16763904;
      
      private static const const_1423:int = 13421772;
      
      private static const const_1421:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_252.getWithIndex(this.var_302);
         if(_loc4_ != null)
         {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1422);
         _loc2_.push(const_1423);
         _loc2_.push(const_1421);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_252.getWithIndex(this.var_302);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_302;
         if(this.var_302 >= this.var_252.length)
         {
            this.var_302 = 0;
         }
         var _loc2_:Map = this.var_252.getWithIndex(this.var_302);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_302 < 0)
         {
            this.var_302 = this.var_252.length - 1;
         }
         var _loc2_:Map = this.var_252.getWithIndex(this.var_302);
         if(_loc2_ != null)
         {
