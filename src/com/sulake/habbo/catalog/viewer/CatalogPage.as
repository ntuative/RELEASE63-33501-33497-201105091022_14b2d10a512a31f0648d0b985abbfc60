package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1882:String = "ctlg_";
       
      
      protected var var_2155:XML;
      ...
      private var var_508:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_508 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1140);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1140);
      }
      ...
      {
         var _loc2_:String = const_1882 + param1;
         ...
         this.var_2155 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2155) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1734:
               if(this.var_1139 == null)
               {
                  this.var_1139 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1139);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1737:
               ...
               break;
            case CatalogWidgetEnum.const_1717:
            ...
            case CatalogWidgetEnum.const_1653:
               ...
               break;
            case CatalogWidgetEnum.const_1709:
            ...
            case CatalogWidgetEnum.const_1771:
               ...
               break;
            case CatalogWidgetEnum.const_1577:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_508.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_508 != null)
         {
            return this.var_508.dispatchEvent(param1);
         }
         return false;
      }
