package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1034:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_253:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_620:Object;
      ...
      {
         this._view.getChildByName(const_1034).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1034).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_253.select(this);
            this.var_620 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_620 != null && this.var_620 == param2)
         {
            _loc3_ = this.var_253.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_620 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_144)
         {
            this.var_620 = null;
         }
      }
