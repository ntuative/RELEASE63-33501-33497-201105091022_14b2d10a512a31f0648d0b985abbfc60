package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarViewStatic implements IToolbarView
   {
      ...
      private static const const_1390:uint = 7433577;
      
      private static const const_1391:uint = 5723213;
      
      private static const const_455:String = "_hover";
      
      private static const const_454:String = "_normal";
      
      private static const const_1005:int = 5;
      ...
      public function ToolbarViewStatic(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         {
            this.setIconHoverState(_loc11_,const_454);
         }
         ...
         param6.addEventListener(HabboToolbarEvent.const_365,this.onToolbarStateEvent);
         param6.addEventListener(HabboToolbarEvent.const_335,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_365,this.onToolbarStateEvent);
            this._events.removeEventListener(HabboToolbarEvent.const_335,this.onToolbarStateEvent);
            this._events = null;
         }
         if(this._catalog != null)
         {
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_365:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.const_335:
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_454);
               this.setIconBgHoverState(_loc3_,const_454);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_455 ? this.var_1403 : this.var_1405;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_455)
         {
            param1.color = const_1390;
         }
         else
         {
            param1.color = const_1391;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1405 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1403)
         {
            this.var_1403.dispose();
         }
         this.var_1403 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1404.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1005;
            _loc2_.y = const_1005;
            this.var_1404.add(param1,_loc2_);
         }
         return _loc2_;
      }
