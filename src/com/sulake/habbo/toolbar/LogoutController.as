package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1523:uint = 12247545;
      ...
      private const const_574:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_296 = this._window.findChildByName("roominfo_region");
         ...
         this.hideRoomInfo();
         this.var_2018 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_2018)
         {
            this._events.addEventListener(HabboToolbarEvent.const_335,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_365,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_2018)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_335,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_365,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      {
         this._list.removeListItem(this.var_296);
      }
      
      private function showRoomInfo() : void
      {
         this._list.addListItemAt(this.var_296,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_475;
         _loc3_.y = this.const_574;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_667)
         {
            this.var_667 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
