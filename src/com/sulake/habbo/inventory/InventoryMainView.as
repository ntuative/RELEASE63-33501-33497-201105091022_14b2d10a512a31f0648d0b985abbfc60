package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2990:IWindowContainer;
      ...
      private const const_1090:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_1213)
         {
         ...
         this._controller.inventoryViewOpened(this.var_789);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_789);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1879);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_525 == InventoryCategory.const_168)
            {
               this.toggleCategoryView(InventoryCategory.const_168);
            }
            else if(this.var_525 == InventoryCategory.const_84)
            {
               this.toggleCategoryView(InventoryCategory.const_84);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_84);
            }
         }
      }
