package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private function showConfirmation() : void
      {
         ...
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_2029.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_66.makeOffer(this.var_2029);
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_2029 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboCatalogCom_ctlg_infopage2" == this._config.getKey("client.credits.embed.enabled"))
         {
