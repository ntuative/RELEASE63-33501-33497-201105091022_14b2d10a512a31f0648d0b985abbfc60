package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private var var_1986:Vector.<Array>;
      
      private var var_1987:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_661 = new Timer(const_1506,1);
         this.var_661.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2728 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_176,this.onObjectPlaced);
               }
            ...
            {
               this.var_661.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_661.stop();
               this.var_661 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1986 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1986;
            }
            else
            {
               if(this.var_1987 == null)
               {
                  this.var_1987 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1987;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_84);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_313)
         {
         ...
         if(this.var_1030 == null)
         {
            this.var_1030 = this._windowManager.buildFromXML(this.var_2728) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1030.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_47,const_49];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_84 && this._controller.isVisible)
         {
            ...
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_49:
                  ...
                  break;
               case CATEGORY_PETS:
                  this._controller.toggleInventoryPage(InventoryCategory.const_168);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_419);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_47,const_49];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_47,const_49];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_660.add(const_47,new Array());
         this.var_660.add(const_49,new Array());
         if(this._view != null)
         {
      ...
      {
         return getTimer() < this.var_2727 + const_1507;
      }
      ...
      public function include(param1:int) : GroupItem
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc4_:* = null;
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_355;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_322 || _loc3_.category == FurniCategory.const_363 || _loc3_.category == FurniCategory.const_313)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_739)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      {
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_700);
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_951);
      }
   }
}
