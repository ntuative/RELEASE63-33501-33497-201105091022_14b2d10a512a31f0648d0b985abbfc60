package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_229:uint = 1;
      
      public static const const_410:uint = 2;
      
      public static const const_334:uint = 3;
      
      public static const const_594:uint = 4;
      
      public static const const_260:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_750);
         this.var_55.updateItemList(this.var_1426);
      ...
      public function close() : void
      {
         if(this.var_803)
         {
            if(this._state != const_196 && this._state != const_260)
            {
      ...
      {
         this.var_55.setMinimized(param1 != InventoryCategory.const_84);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_749 + " OTHER: " + this.var_1153);
         ...
         {
            case const_196:
               if(param1 == const_229 || param1 == const_260)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1111);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_750)
            {
               this.var_749 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1153 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_750)
            {
               this.var_55.alertPopup(TradingView.const_1305);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_246.length < const_1862)
         {
