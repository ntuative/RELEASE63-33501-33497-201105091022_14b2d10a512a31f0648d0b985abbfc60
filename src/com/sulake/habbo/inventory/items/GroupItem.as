package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_882:int = 0;
      
      protected var var_714:BitmapData;
      
      protected var var_2279:int;
      
      protected var var_1643:Boolean;
      
      protected var var_2174:Boolean;
      
      protected var var_2962:BitmapData;
      
      private const const_2194:int = 8947848;
      
      private const const_2193:int = 13421772;
      
      private const const_1924:Number = 1;
      
      private const const_1925:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2961 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1451));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2156);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_739)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1925;
               _loc1_.blend = this.const_1925;
            }
            else
            {
               this._window.blend = this.const_1924;
               _loc1_.blend = this.const_1924;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2174 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2962;
               _loc5_.visible = true;
            }
            else
            {
