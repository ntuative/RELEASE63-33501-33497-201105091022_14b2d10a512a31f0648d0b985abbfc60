package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1970:IAlertDialog;
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_184,HabboToolbarIconEnum.QUESTS));
      ...
      {
         return this._questEngine.configuration.getKey("standaloneAchievementList.enabled","false") == "HabboCatalogCom_ctlg_infopage2";
      }
   }
}
