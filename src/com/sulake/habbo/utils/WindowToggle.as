package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1256:int = 2;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1051)
            {
               this.var_1051.addChild(this._window);
            }
