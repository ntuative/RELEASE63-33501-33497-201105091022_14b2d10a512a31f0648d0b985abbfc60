package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_824)
         {
            this.var_824 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_824)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_825)
         {
            this.var_825 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_825)
            {
               return;
            }
