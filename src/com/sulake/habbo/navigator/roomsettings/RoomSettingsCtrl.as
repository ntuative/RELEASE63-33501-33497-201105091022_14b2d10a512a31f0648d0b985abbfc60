package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_421:IRoomSettingsCtrlOwner;
      ...
      private var var_748:TextFieldManager;
      
      private var var_1145:TextFieldManager;
      ...
      private var var_1148:ICheckBoxWindow;
      ...
      private var var_1146:IWindowContainer;
      ...
      {
         this.var_350 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_350));
         if(this.var_1146 != null)
         {
            this.var_1146.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_350)
         {
            return;
         }
         this.var_74 = param1;
         this._active = true;
         this.var_1736 = true;
         this.var_421.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_350 || this.var_1150 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1150 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1680)
         {
            this.var_748.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1710)
         {
            this.var_748.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1817)
         {
            this.var_1145.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1722)
         {
            this.setTagError(this.var_923,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_921,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1748)
         {
            this.setTagError(this.var_923,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_921,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1635)
         {
            this.var_922.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_748.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_748.clearErrors();
         this.var_1145.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_557,this.onDoorModePasswordUnselect);
         ...
         this.var_748 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1145 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_923 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         ...
         this.var_1149 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1147 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1143 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1148 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         ...
         this.var_1151 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1144 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1737 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1425 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_245 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1146 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1424 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1424.mouseThreshold = 0;
         this.var_1424.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1146.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1737.visible = this._inRoom;
         if(this.var_747)
         {
            this.var_1144.visible = true;
            this.var_1425.visible = false;
            this.refreshFlatControllers();
            this.var_1144.height = Util.getLowestPoint(this.var_1144) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1151.visible = true;
            this.var_1425.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1151.height = Util.getLowestPoint(this.var_1151) + 4;
         }
         this.var_1424.text = !!this.var_747 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1151.name,this.var_1144.name,this.var_1425.name,this.var_1737.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_748.setText(_loc1_.name);
         this.var_1145.setText(_loc1_.description);
         this.var_922.setText("");
         this.var_1149.setText("");
         ...
         this.setTag(this.var_923,_loc1_.tags[0]);
         ...
         if(this.var_1148)
         {
            ...
            {
               this.var_1148.select();
            }
            else
            {
               this.var_1148.unselect();
            }
         }
         if(this.var_609)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_748.getText();
         _loc2_.description = this.var_1145.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_625;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_132)
         {
            _loc8_ = this.var_922.getText();
            _loc9_ = this.var_1149.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_922.clearErrors();
               this.var_1149.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1147.isSelected;
         _loc2_.allowFoodConsume = this.var_1143.isSelected;
         _loc2_.allowWalkThrough = this.var_1148.isSelected;
         _loc2_.hideWalls = this.var_609.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_923,_loc2_.tags);
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_350);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_350]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_184,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_68,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_350));
      }
