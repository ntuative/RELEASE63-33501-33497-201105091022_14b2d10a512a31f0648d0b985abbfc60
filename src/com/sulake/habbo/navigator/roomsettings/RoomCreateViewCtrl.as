package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1295:TextFieldManager;
      
      private var var_43:Array;
      
      private var var_1296:RoomLayout;
      
      private var var_673:Timer;
      
      private var var_2028:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_673 = new Timer(100);
         this.var_673.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_43 = new Array();
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,104,"a"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,94,"b"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,36,"c"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,84,"d"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,80,"e"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,80,"f"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,416,"i"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,320,"j"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,448,"k"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,352,"l"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,384,"m"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_56,372,"n"));
         ...
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,540,"t"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,512,"w"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,396,"x"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,440,"y"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,456,"z"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_673)
         {
            this.var_673.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_673.reset();
            this.var_673 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1296.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2028 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2028 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1295 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_186.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1295.goBackToInitialState();
         this.var_1295.input.textBackgroundColor = 4294967295;
         this.var_1296 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_68,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1295.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1295.getText();
         var _loc3_:String = "model_" + this.var_1296.name;
