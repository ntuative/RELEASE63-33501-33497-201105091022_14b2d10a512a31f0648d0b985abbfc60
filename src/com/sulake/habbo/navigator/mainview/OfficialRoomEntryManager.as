package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1555:int = 267;
      
      private static const const_1557:int = 65;
      
      private static const const_1556:int = -70;
      ...
      private var var_2823:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2823 = new PublicRoomThumbs();
         super();
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_836 || param2.type == OfficialRoomEntryData.const_775))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1557) : int(const_1555);
      ...
      {
         var _loc4_:String = this.var_2823.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1556) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_288,Tabs.const_414,_loc2_.tag);
         }
