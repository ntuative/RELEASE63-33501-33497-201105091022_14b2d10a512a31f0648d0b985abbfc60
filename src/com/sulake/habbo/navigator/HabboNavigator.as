package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_472:RoomInfoViewCtrl;
      
      private var var_1312:RoomCreateViewCtrl;
      ...
      private var var_3035:Dictionary;
      
      private var var_1540:IncomingMessages;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_2854:Array;
      
      private var var_2525:RoomThumbnailRenderer;
      
      private var var_922:GuestRoomPasswordInput;
      
      private var var_318:GuestRoomDoorbell;
      
      private var var_1311:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2854 = new Array();
         ...
         this.var_472 = new RoomInfoViewCtrl(this);
         this.var_1312 = new RoomCreateViewCtrl(this);
         this.var_2525 = new RoomThumbnailRenderer(this);
         this.var_922 = new GuestRoomPasswordInput(this);
         this.var_318 = new GuestRoomDoorbell(this);
         this.var_431 = new Tabs(this);
         this.var_1311 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_318,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_472.registerToolbarEvents();
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_35)
         {
            ...
            {
               this.var_472.handleToolbarEvent(param1);
            }
      ...
      {
         var _loc1_:Boolean = this.var_326.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_326.startSearch(Tabs.const_288,Tabs.const_414,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_326.startSearch(Tabs.const_337,Tabs.const_275);
         this.var_431.getTab(Tabs.const_337).tabPageDecorator.tabSelected();
      }
