package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_614 && this.var_1444)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_97,this.var_933,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_912));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1444 && this.var_614 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this._controller.handler.saveWardrobeOutfit(this.var_1769,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_614)
               {
                  this._controller.loadAvatarInEditor(this.var_614,this.var_933,this._controller.clubMemberLevel);
               }
         }
      }
