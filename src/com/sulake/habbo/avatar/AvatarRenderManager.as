package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2172:String = "hd-99999-99999";
      ...
      private var var_222:AvatarAssetDownloadManager;
      
      private var var_1858:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_337 = RenderMode.const_1809;
         this.var_308 = new Map();
         this.var_102 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_134,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_102.add(AvatarType.const_134,_loc4_);
         _loc4_ = new AvatarStructure(this,AvatarType.const_74,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_102.add(AvatarType.const_74,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_222)
         {
            this.var_222.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_307.init();
         this.var_784.init();
         _loc2_ = this.var_102.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_102.getValue(AvatarType.const_74) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_102.getValue(AvatarType.const_134) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_222 == null)
               {
                  ...
                  this.var_222 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_222.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1050)
         {
            if(this.var_2494 && this.var_2495 && this.var_2493)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_222.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_222.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_102.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_222.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1858)
         {
            this.var_1858 = new AvatarFigureContainer(this.const_2172);
         }
         this.var_222.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1858,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_307.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1596)
         {
            _loc6_ = !this.var_307.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_307.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_102.getValue(AvatarType.const_74) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_102.getValue(AvatarType.const_74);
      ...
      {
         var _loc3_:AvatarStructure = this.var_102.getValue(AvatarType.const_134) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_134:
               _loc3_ = this.var_102.getValue(AvatarType.const_134) as AvatarStructure;
               break;
            case AvatarType.const_74:
               _loc3_ = this.var_102.getValue(AvatarType.const_74) as AvatarStructure;
               break;
            default:
