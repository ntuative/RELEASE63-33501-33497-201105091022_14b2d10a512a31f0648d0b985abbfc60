package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_2221:String = null;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51 || param1 == AvatarSetType.const_36)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_243.length == 1 && this.var_89 == this.var_1997)
         {
            return this.var_89 + this.var_495 + this.var_592 % 4;
         }
         if(this.var_243.length == 2)
         {
            for each(_loc1_ in this.var_243)
            {
               ...
               {
                  return this.var_89 + this.var_495 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_592 % 11;
                  return this.var_89 + "_" + this.var_1997 + this.var_495 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2220 || param2 != this.var_2221 || param1 != this.var_2222)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1347 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1347)
            {
               this.var_45.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_592);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_592);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_334.push(new ActiveActionData(param1,param2,this.var_592));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_962);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_495 = "";
         this.var_243 = this._structure.sortActions(this.var_334);
         if(this.var_243 == null)
         {
         ...
         {
            this.var_849 = this._structure.getCanvasOffsets(this.var_243,this._scale,this.var_89);
            for each(_loc4_ in this.var_243)
            {
               ...
               if(_loc4_.actionType == AvatarAction.const_348)
               {
                  ...
                  if(this.var_1388 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1388 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_243)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_327 || _loc1_.actionType == AvatarAction.const_285 || _loc1_.actionType == AvatarAction.const_406)
               {
                  this.var_961 = true;
               }
            }
