package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1516:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1518:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_848:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1283:AvatarEditorHandler;
      ...
      private var var_1041:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_545)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_192)
         {
            ...
            this.var_666["null"] = new FigureData(this);
            this.var_666["null"] = new FigureData(this);
            _loc2_ = this.var_666["null"];
            _loc3_ = this.var_666["null"];
            _loc2_.loadAvatarData(const_1516,FigureData.const_78);
            _loc3_.loadAvatarData(const_1518,FigureData.FEMALE);
            this.var_100 = new Map();
            this.var_545 = new Map();
            this.var_100.add(AvatarEditorFigureCategory.const_732,new BodyModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_296,new TorsoModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_721,new LegsModel(this));
            ...
            this.var_545.add(AvatarEditorSideCategory.const_112,new WardrobeModel(this));
            this.var_545.add(AvatarEditorSideCategory.const_506,new ClubPromoModel(this));
            this.var_192 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_666[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1041.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1041.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_270 == null)
            {
               this.var_270 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_68,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_732);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_545.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_848 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_546 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1041 = this.var_546.getFigureData(AvatarType.const_134);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1283 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_666[this.var_933];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1566 != null)
         {
            ...
            this.var_1566.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2011;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1282 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1517)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1634.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_546.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_546.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1346.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1825)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1282 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1346.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1282 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_545.getValue(AvatarEditorSideCategory.const_112);
      }
