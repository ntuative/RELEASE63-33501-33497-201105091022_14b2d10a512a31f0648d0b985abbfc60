package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_671:String = "tab_boy";
      
      private const const_672:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_66.controller.gender)
         {
            case FigureData.const_78:
               activateTab(this.const_671);
               inactivateTab(this.const_672);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_672);
               inactivateTab(this.const_671);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_671:
                  var_66.controller.gender = FigureData.const_78;
