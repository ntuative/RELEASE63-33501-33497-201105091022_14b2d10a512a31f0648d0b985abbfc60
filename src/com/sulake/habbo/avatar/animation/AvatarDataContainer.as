package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1328:Map;
      
      private var var_2900:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2081 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2901 = parseInt(_loc2_,16);
         this.var_2902 = parseInt(_loc3_,16);
         ...
         this.var_850 = new ColorTransform(this.var_1851,this.var_1850,this.var_1852,this._alphaMultiplier);
         this.var_1328 = this.generatePaletteMapForGrayscale(this.var_2902,this.var_2901);
      }
      ...
      {
         return this.var_1328.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1328.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1328.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1328.getValue("alphas") as Array;
      }
