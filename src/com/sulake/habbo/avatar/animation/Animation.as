package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1796:AvatarDataContainer;
      
      private var var_1458:Array;
      
      private var var_1798:DirectionDataContainer;
      
      private var var_1797:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1654 = String(param2.@desc);
         }
         else
         {
         ...
         {
            this.var_1796 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1798 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1797 = new ShadowDataContainer(param2.shadow[0]);
         }
         ...
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.method_4)
            {
               ...
               this.var_622.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_585,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_585)
            {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_585)
            {
               for each(_loc5_ in this.var_774)
               {
      ...
      {
         return this.var_1798 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_1797 != null;
      }
