package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2130:int = 6710886;
      ...
      private var var_521:IFrameWindow;
      ...
      private var var_2466:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1196 = [];
         this.var_1469 = [AvatarEditorFigureCategory.const_732,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_296,AvatarEditorFigureCategory.const_721,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_112];
         super();
         ...
         if(var_1346 == null)
         {
            ...
            var_1346 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1634 == null)
         {
         ...
         this.var_440 = new Timer(1000);
         this.var_440.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1469;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_440.stop();
            this.var_440.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_440 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1469);
         }
         if(param1.length != this.var_1196.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1196.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2465 = this.canChangeOutfit();
            this.var_440.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1196.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1469;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1840 == AvatarEditorSideCategory.const_112 || this.var_2466))
         {
         ...
         this.setViewToCategory(this.var_399);
      }
      ...
      {
         if(this.var_1840 == AvatarEditorSideCategory.const_112)
         {
            this.var_2466 = false;
            this.setSideContent(AvatarEditorSideCategory.const_957);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_957:
               break;
            case AvatarEditorSideCategory.const_506:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_506);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2464 = new Date().valueOf();
                  this.var_2465 = false;
                  this.var_440.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_521)
         {
            ...
            this.var_521 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_521.procedure = this.stripClubDialogEventProc;
            this.var_521.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2464 > 5000;
      }
   }
}
