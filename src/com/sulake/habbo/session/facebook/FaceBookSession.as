package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1056:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1488:String = "sendAccessTokenToServer";
      
      private static const const_1487:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1488,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1487,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1056);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1056);
         }
      }
