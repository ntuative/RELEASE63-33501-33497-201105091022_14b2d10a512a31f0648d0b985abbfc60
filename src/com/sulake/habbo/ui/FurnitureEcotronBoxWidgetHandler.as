package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_875,RoomWidgetEcotronBoxOpenMessage.const_979,RoomWidgetEcotronBoxOpenedMessage.const_1634];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_875:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_979:
