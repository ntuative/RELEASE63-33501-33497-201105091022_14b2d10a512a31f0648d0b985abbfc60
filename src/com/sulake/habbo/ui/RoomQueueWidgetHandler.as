package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_988);
         _loc1_.push(RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_877);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_810);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_988:
               this._container.roomSession.quit();
               break;
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1173);
               break;
            case RoomWidgetRoomQueueMessage.const_877:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1176);
               break;
            case RoomWidgetRoomQueueMessage.const_810:
      ...
      {
         return [RoomSessionQueueEvent.const_495];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_495:
               ...
               {
                  case RoomSessionQueueEvent.const_1176:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1173:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1673) + 1;
                  }
               }
               else
               {
