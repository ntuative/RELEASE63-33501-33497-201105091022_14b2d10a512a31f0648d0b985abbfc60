package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_228.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_148,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_148,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_228 != null)
         {
            this.var_228.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_946);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_759);
         _loc1_.push(RoomWidgetFurniActionMessage.const_253);
         _loc1_.push(RoomWidgetFurniActionMessage.const_965);
         _loc1_.push(RoomWidgetFurniActionMessage.const_719);
         _loc1_.push(RoomWidgetFurniActionMessage.const_845);
         _loc1_.push(RoomWidgetFurniActionMessage.const_865);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_856);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_738);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_709);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1754);
         _loc1_.push(RoomWidgetPetCommandMessage.const_571);
         _loc1_.push(RoomWidgetPetCommandMessage.const_934);
         _loc1_.push(RoomWidgetUserActionMessage.const_541);
         _loc1_.push(RoomWidgetUserActionMessage.const_432);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_932);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_432 || param1.type == RoomWidgetUserActionMessage.const_541 || param1.type == RoomWidgetUserActionMessage.const_581)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_946:
            ...
            case RoomWidgetUserActionMessage.const_486:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_909,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_601:
               ...
               break;
            case RoomWidgetUserActionMessage.const_759:
            ...
            case RoomWidgetUserActionMessage.const_581:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_965:
            ...
            case RoomWidgetFurniActionMessage.const_845:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_865:
            ...
            case RoomWidgetUserActionMessage.const_432:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_856:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_738:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_709:
            ...
            case RoomWidgetUserActionMessage.const_520:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_934:
            ...
            case RoomWidgetPetCommandMessage.const_571:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_932:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_247);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_350) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_350);
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_247);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1320);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1106);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_552)
                  {
                     _loc30_ = this.var_228.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_418) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_418.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_228.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_151)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_485)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_542);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_135)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_114)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_718);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_733;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_735;
                  }
               ...
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_36,4);
                  _loc14_.image = _loc20_.getImage(AvatarSetType.const_36,true);
                  _loc20_.dispose();
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_718);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_228 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_228.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_384,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_228 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_388,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
