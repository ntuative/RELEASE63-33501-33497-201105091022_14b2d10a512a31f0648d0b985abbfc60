package com.sulake.habbo.ui
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this._container)
            {
               ...
               {
                  this._container.toolbar.events.removeEventListener(HabboToolbarEvent.const_35,this.onToolbarClicked);
               }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.toolbar)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_35,this.onToolbarClicked);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_771);
      ...
      {
         return [RoomSessionUserDataUpdateEvent.const_138];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_771:
               this.dispatchOwnAvatarInfo();
               break;
