package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_590 = this.getKey("url_prefix");
         if(this.var_590 != null && this.var_590.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_590 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1800);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         for each(line in rows)
         {
            if(line.substr(0,1) != "#")
            {
               ...
               if(pair[0].length > 0 && pair[1].length > 0)
               {
                  ...
                  if(key == "configuration.readonly" && value == "HabboCatalogCom_ctlg_infopage2")
                  {
                     readOnly = true;
                  }
         ...
         if(this.getKey("local.environment") == "HabboCatalogCom_ctlg_infopage2")
         {
            this.setKey("url.prefix",this.getKey("url.prefix.local"));
         }
         this.var_590 = this.getKey("url.prefix");
         if(this.var_590.length > 0)
         {
            externalAccessDomain = this.var_590.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_896[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_896[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_590);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_1678.indexOf(param1) < 0 || param3)
         {
      ...
      {
         var _loc3_:String = this.var_896[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }
         return _loc3_ == "1" || _loc3_.toLowerCase() == "HabboCatalogCom_ctlg_infopage2";
      }
   }
}
