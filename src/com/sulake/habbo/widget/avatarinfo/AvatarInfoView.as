package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1512:int = 25;
      ...
      protected var var_2177:FixedSizeStack;
      
      protected var var_2175:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2177 = new FixedSizeStack(const_1512);
         super();
         this._widget = param1;
      }
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1361)
         {
            ...
            if(this.var_1644 == RoomObjectTypeEnum.const_151 || this.var_1644 == RoomObjectTypeEnum.const_485)
            {
            ...
            this.var_2177.addValue(_loc5_);
            _loc6_ = this.var_2177.getMax();
            if(_loc6_ < this.var_2175 - const_1066)
            {
               _loc6_ = this.var_2175 - const_1066;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2175 = _loc6_;
