package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1278:TagListRenderer;
      
      private var var_143:IBorderWindow;
      
      private var var_2920:int;
      
      private var var_2921:Boolean = true;
      
      private const const_1098:int = 5;
      
      private const const_1945:int = 7829367;
      
      private const const_1944:int = 16777215;
      
      private const const_2210:int = 2000;
      
      private const const_2209:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1278 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2921 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_143.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_143.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_143.x = _loc5_.left - this.var_143.width;
         this.var_143.y = _loc5_.top + (_loc5_.height - this.var_143.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_143.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_143.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_143.x = _loc7_.left - this.var_143.width;
         this.var_143.y = _loc7_.top + (_loc7_.height - this.var_143.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_143 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_143 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1098;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1945;
            }
            else
            {
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1098,this.const_2209);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_368,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_368,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1278.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_135);
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2920 > this.const_2210 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2920 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1945;
         }
      }
