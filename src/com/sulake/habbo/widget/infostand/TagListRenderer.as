package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_151:Function;
      
      private var _offsetX:int;
      
      private var var_1244:int;
      
      private var var_1243:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1244 = 0;
         this.var_1243 = param2.rectangle.clone();
         this.var_1243.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1243.width)
         {
            return false;
         }
         if(this.var_1244 + param1.height > this.var_1243.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1243.width)
         {
            this._offsetX = 0;
            this.var_1244 += param1.height + this.const_2179;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1244);
         this._offsetX += param1.width + this.const_2180;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1519 != null && this.var_1519.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_151);
