package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1085:int = 3;
      
      public static const const_629:int = 2;
      
      public static const const_379:int = 1;
      
      public static const const_271:int = 0;
      
      public static const const_86:int = 39;
      
      private static const const_1030:int = 150;
      ...
      private var var_2400:BitmapData;
      ...
      private var var_2402:BitmapData;
      
      private var var_2403:BitmapData;
      
      private var var_2399:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2400 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1784 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2398 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         ...
         this.var_2402 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2403 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_75 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_318,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_75);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_68,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_41.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_561,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_629:
               this.var_75.blend += param1 / const_1031;
               this._window.blend += param1 / const_1031;
               ...
               break;
            case const_1085:
               this.var_75.blend -= param1 / const_1030;
               this._window.blend -= param1 / const_1030;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_379:
               if(this._state == const_271)
               {
                  this.state = const_629;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2399;
         }
         if(this.var_75 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2401 == this._window.width)
         {
            return;
         }
         this.var_2401 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2398;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1783;
            barX.disposesBitmap = false;
            this.var_2399 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2400,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1784,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1784,destGripRBitmap);
         ...
         this.var_75.bitmap = this.var_2403;
