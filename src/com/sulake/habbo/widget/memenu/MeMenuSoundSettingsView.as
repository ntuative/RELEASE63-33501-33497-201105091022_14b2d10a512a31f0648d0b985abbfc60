package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_515 = param1.volume;
         if(this.var_991 != null)
         {
            this.var_991.setValue(this.var_515);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_955));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_515 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1903);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1902);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_515 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1901);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1904);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_802);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_960);
         }
