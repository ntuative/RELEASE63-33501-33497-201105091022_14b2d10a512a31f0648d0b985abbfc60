package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_633,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_509,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_633,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_509,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_69:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_509:
               if(!this.var_387)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_498:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_633:
               if(!this.var_387)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(this.var_387 || this.var_193 == -1 || !this._controller)
         {
            return;
         }
         this.var_387 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_175,this.var_193);
