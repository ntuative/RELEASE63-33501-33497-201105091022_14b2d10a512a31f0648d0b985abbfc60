package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2982:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2982 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_425:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_58,this._habboConfiguration,this.var_2404++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this._habboConfiguration.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_58,this._habboConfiguration,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_58,this._habboConfiguration,this);
               }
               break;
            case RoomWidgetEnum.const_519:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_58,this._habboConfiguration,this._catalog);
               break;
            case RoomWidgetEnum.const_579:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_58,events,this._habboConfiguration);
               break;
            ...
            case RoomWidgetEnum.const_534:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_58,this._habboConfiguration,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_484:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_58,this._habboConfiguration);
               break;
            case RoomWidgetEnum.const_895:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_58,this._habboConfiguration);
               break;
            case RoomWidgetEnum.const_128:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_58,this._habboConfiguration);
               break;
            ...
            case RoomWidgetEnum.const_129:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this._habboConfiguration,this.var_58,this);
               break;
            ...
            case RoomWidgetEnum.const_612:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_58,this._habboConfiguration,this._catalog);
               break;
