package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_853:String = "MISV_BUY_MORE";
      
      public static const const_751:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1647.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_751,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_853,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_449.add(const_751,_loc1_);
            this.var_1648 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1647 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_489));
         ...
         if(_loc1_ != null)
         {
            this.var_449.add(const_853,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_641));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_449[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
