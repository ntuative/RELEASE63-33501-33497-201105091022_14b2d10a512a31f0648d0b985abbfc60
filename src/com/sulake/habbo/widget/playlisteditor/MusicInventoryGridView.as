package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_228.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_228.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_228.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_228.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
      ...
      public function setPreviewIconToPause() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_1168;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_635;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_144;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_98.playButtonState == MusicInventoryGridItem.const_635)
               {
                  this.var_98.playButtonState = MusicInventoryGridItem.const_1233;
