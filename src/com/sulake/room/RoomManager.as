package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_151:IRoomManagerListener;
      
      private var var_3021:IRoomContentLoader;
      
      private var var_606:IRoomObjectFactory = null;
      
      private var var_505:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1134:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_503,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_724,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_606 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_606 == null || this.var_505 == null)
         {
            return;
         }
         this._state = const_1852;
         if(this.var_1134 != null)
         {
            _loc1_ = this.var_1134;
            this.var_1134 = null;
            this.initialize(_loc1_,this.var_151);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_607.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_607.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_607.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_607[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_606.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_606 != null)
         {
            return this.var_606.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_754)
         {
            return;
         }
         if(this.var_53 == null)
         {
            this._state = const_754;
            return;
         }
         if(this.var_53.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_608.length == 0)
            {
               ...
               {
                  this.var_151.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_754;
            this.var_151.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_151 != null)
            {
               this.var_151.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_919.indexOf(_loc2_) < 0)
         {
            this.var_919.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_919.length > 0)
         {
            _loc2_ = this.var_919[0];
            this.var_919.splice(0,1);
            _loc3_ = this.var_53.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_151 != null)
               {
                  this.var_151.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_151 != null)
            {
               this.var_151.contentLoaded(_loc2_,true);
            }
            if(this.var_608.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_53 == null || this.var_505 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_606.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_151 != null)
                              {
                                 this.var_151.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
