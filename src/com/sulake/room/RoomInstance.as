   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_262 != null)
         {
            ...
            {
               _loc3_ = this.var_262.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_596)
            {
               delete this.var_596[_loc1_];
            }
            this.var_596 = null;
         }
      ...
      {
         return this.var_596[param1];
      }
      
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         if(this.var_1391.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_607.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_607[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_262.getValue(_loc2_) != null)
         {
            return this.var_262.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_262.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_262.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_262.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
