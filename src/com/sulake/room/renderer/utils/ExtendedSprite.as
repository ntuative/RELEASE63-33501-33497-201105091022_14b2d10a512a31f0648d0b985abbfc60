package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1632:int = 128;
      
      private var var_1631:Boolean = false;
      
      private var var_3010:Point;
      ...
      {
         if(param1 != this.var_2110 || param2 != this.var_2111)
         {
      ...
      {
         if(this.var_1632 > 255 || bitmapData == null)
         {
            return false;
         }
